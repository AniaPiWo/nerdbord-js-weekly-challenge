...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6996)), "D:\\Nerdboard\\nerdbord-js-weekly-challenge\\app\\week-1\\page.tsx"],
    ...
    const originalPathname = "/week-1/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3012))
...
/* harmony import */ var _Stars_module_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4361);
/* harmony import */ var _Stars_module_css__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_Stars_module_css__WEBPACK_IMPORTED_MODULE_2__);
/* __next_internal_client_entry_do_not_use__ Stars auto */ 


const Stars = ({ rows, columns })=>{
    const [stars, setStars] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(Array(rows * columns).fill(false));
    const [isHovered, setIsHovered] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
    const starElementsRef = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)([]);
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        const starElements = starElementsRef.current;
        let startTime = Date.now();
        starElements.forEach((starElement, index)=>{
            const randomDelay = index < rows * columns && Date.now() - startTime < 1000 ? Math.random() * 50 : Math.random() * 1000;
            starElement.style.animationDelay = `${randomDelay}s`;
        });
    }, []);
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        className: (_Stars_module_css__WEBPACK_IMPORTED_MODULE_2___default().starsBox),
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                onMouseEnter: ()=>setIsHovered(true),
                onMouseLeave: ()=>setIsHovered(false),
                children: !isHovered ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                    className: (_Stars_module_css__WEBPACK_IMPORTED_MODULE_2___default().stars),
                    children: stars.map((value, index)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                            className: (_Stars_module_css__WEBPACK_IMPORTED_MODULE_2___default().star),
                            ref: (el)=>starElementsRef.current[index] = el
                        }, `${index}-${value}`))
                }) : /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                    className: (_Stars_module_css__WEBPACK_IMPORTED_MODULE_2___default().stars),
                    children: stars.map((value, index)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                            className: (_Stars_module_css__WEBPACK_IMPORTED_MODULE_2___default().unity),
                            ref: (el)=>starElementsRef.current[index] = el
                        }, `${index}-${value}`))
                })
            }),
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h1", {
                children: "The universe is you."
            })
        ]
    });
};
...
// Exports
module.exports = {
	"starsBox": "Stars_starsBox__NrsFE",
	"stars": "Stars_stars__sn6D6",
	"star": "Stars_star__RO8Ha",
	"twinkle": "Stars_twinkle__oQY4s",
	"unity": "Stars_unity__8YHyB"
};
...
;// CONCATENATED MODULE: ./src/challenges/s1-week-1/Stars.tsx

const proxy = (0,module_proxy.createProxy)(String.raw`D:\Nerdboard\nerdbord-js-weekly-challenge\src\challenges\s1-week-1\Stars.tsx`)
...
const e0 = proxy["Stars"];

;// CONCATENATED MODULE: ./app/week-1/page.tsx
...
/* harmony default export */ const page = (Week1);
...
var __webpack_exports__ = __webpack_require__.X(0, [381,435,244], () => (__webpack_exec__(5548)));
